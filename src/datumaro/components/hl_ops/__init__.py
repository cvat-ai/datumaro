...
class HLOps:
    ...
    def compare(
        ...
        **kwargs,
        ...
        Args:
            ...
            report_dir (Optional[str], optional): The directory path to save the comparison report.
                Defaults to None.
            method (str, optional): The comparison method to use.
                Possible values are "table", "equality", "distance". Defaults to "table".
    ...
    def merge(
        ...
        **kwargs,
        ...
        """
        Merge `datasets` according to `merge_policy`.
        You have to choose an appropriate `merge_policy` for your purpose.
        The available merge policies are "union", "intersect", and "exact".
    ...
    @staticmethod
    def aggregate(dataset: Dataset, from_subsets: Iterable[str], to_subset: str) -> IDataset:

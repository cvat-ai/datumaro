    ...
    def _load_categories(self, json_data, *, keep_original_ids):
        ...
        if found:
            ...
            log.warning(
                ...
                "Please be warned that annotations with category "
                "id of '0' would have `None` as label. "
                "(https://openvinotoolkit.github.io/datumaro/latest/"
                "docs/explanation/formats/coco.html#import-coco-dataset)"
            )

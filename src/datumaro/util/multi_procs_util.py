...
def consumer_generator(
    ...
    This context manager sets up a producer thread that generates items
    from the `producer_generator` and enqueues them to be consumed
    by the consumer generator, which is also created by this function.
    ...
    Parameters:
        ...
        join_timeout: The maximum time to wait for the producer thread to finish when
            exiting the context. If None, wait until the producer thread terminates.
